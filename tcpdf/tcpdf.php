	...
	class TCPDF {
		...
		*/
		protected function _putviewerpreferences() {
			...
			if (isset($this->viewer_preferences['sbm_hideMenubar']) AND ($this->viewer_preferences['sbm_hideMenubar'])) {
				$this->_out('/sbm_hideMenubar true');
			}
